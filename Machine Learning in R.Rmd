...
##### Challenge 1  
1. Using what you learned above, classify knn predictive accuracies of the `Species` variable in the  "iris" dataset. 
...
### Challenge 2
1) Set up a regression model that predicts one of the numeric variables from the "iris" dataset. 
