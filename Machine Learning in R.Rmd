...
What happened? Was scaling necessary in this case? 
```{r}
boxplot(data, las = 2)
```
...
**Big question 1:** What might you conclude about the k-nearest neighbors algorithm and this particular dataset? (see the solutions notebook for an answer)  

##### Challenge 1  
1. Using what you learned above, classify predictive accuracies of the `Species` variable in the  "iris" dataset. 
...
lm_age <- lm(pidd$age ~ ., data = subset(pidd, select = -age))
data2_lm <- lm(Y_reg ~ ., data = data_reg)
...
data2_predicted <- predict(data2_lm, data_reg) 

# Calculate mean-squared error. 
MSE <- mean((Y_reg - data2_predicted)^2)   
