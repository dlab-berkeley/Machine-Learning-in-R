...
For a real project, it would be ideal to create 5, 10, or 50 tuned versions of the same algorithm for comparison not only against different algorithms, but also against other tuned versions of itself.  
