...
knn_k <- knnEval(data_scaled, Y, as.numeric(row.names(train)), 
...
3. Using what you learned above, how would you classify the predictive accuracy of the Species vector in the  "iris" dataset?
