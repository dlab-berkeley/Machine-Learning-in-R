...
Did you notice the warning message after the code  
`reg_predicted = predict(reg_fit, test_x_reg)` ? 

> Warning message:
In predict.lm(reg_fit, test_x_reg) :
  prediction from a rank-deficient fit may be misleading

[Here we have a rank-deficient matrix](https://stats.stackexchange.com/questions/35071/what-is-rank-deficiency-and-how-to-deal-with-it) that prevents OLS from potentially working correctly.  
