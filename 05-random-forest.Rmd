...
Fit a random forest model that predicts the number of people with diabetes using the other variables as our X predictors. If our Y variable is a factor, ranger will by default perform classification; if it is numeric/integer regression will be performed and if it is omitted it will run an unsupervised analysis.
