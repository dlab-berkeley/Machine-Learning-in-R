...
# x features 
train_x_reg <- juice(recipe_reg, all_predictors()) 
test_x_reg <- bake(recipe_reg, raw_test_x_reg, all_predictors())

# y variables 
train_y_reg <- juice(recipe_reg, all_outcomes())
test_y_reg <- bake(recipe_reg, raw_test_x_reg, all_outcomes())

# First 6 rows 
head(train_x_reg) # Make sure there's no age variable!
head(train_y_reg) # Make sure this is age variable!
...
# x features 
train_x_class <- juice(recipe_class, all_predictors()) 
test_x_class <- bake(recipe_class, raw_test_x_class, all_predictors())

# y variables 
train_y_class <- juice(recipe_class, all_outcomes())
test_y_class <- bake(recipe_class, raw_test_x_class, all_outcomes())

# First 6 rows 
head(train_x_class) # Make sure there's no target variable!
head(train_y_class) # Make sure this is target variable!
