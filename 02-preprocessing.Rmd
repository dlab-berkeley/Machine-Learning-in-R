...
```{r}
pidd = ck37r::standardize(pidd, skip_vars = c("age", "diabetes", "miss_glucose", "miss_pressure", "miss_triceps", "miss_insulin", "miss_mass"))
...
We then can use [stratified random sampling](https://en.wikipedia.org/wiki/Stratified_sampling) to divide our data into training and test sets; 70% of the data will be assigned to the training set and the remaining 30% will be assigned to the holdout, or test, set. 
```{r caret_split}
# Set seed for reproducibility.
set.seed(1)
