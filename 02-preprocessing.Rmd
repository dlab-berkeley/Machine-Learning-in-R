...
# y variables 
train_y_reg <- train_x_reg$age %>% as.numeric()
test_y_reg <- test_x_reg$age %>% as.numeric()
...
# y variables 
train_y_class <- train_x_class$target %>% as.numeric()
test_y_class <- test_x_class$target %>% as.numeric()
