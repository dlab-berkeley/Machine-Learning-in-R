...
# y variables 
train_y_reg <- juice(recipe_reg, all_outcomes())$age %>% as.numeric()
test_y_reg <- bake(recipe_reg, raw_test_x_reg, all_outcomes())$age %>% as.numeric()
...
# y variables 
train_y_class <- juice(recipe_class, all_outcomes())$target %>% as.factor()
test_y_class <- bake(recipe_class, raw_test_x_class, all_outcomes())$target %>% as.factor()
