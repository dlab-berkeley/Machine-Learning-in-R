...
>BONUS: PCA and hierarical clustering unsupervised methods
...
Want to apply your newfound skills to building deep neural networks using Keras in R? Check out our Introduction to Deep Learning in R! Join us to learn about the below graph that represents a neural network for classifying images of dogs and humans - and how to tell if it is doing a good job: 
...
Repository: https://github.com/dlab-berkeley/Deep-Learning-in-R