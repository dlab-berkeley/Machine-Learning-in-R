...
What are these other variables? Load the data and find out! Open **"1-overview.Rmd"** to install and import the necessary packages for this workshop. Then, open **"2-preprocessing.Rmd"** to get started with the data.  
...
![asdf](K-fold_cross_validation_EN.jpg)

[4 fold cross-validation image by Fabian Flöck - Own work, CC BY-SA 3.0](https://commons.wikimedia.org/w/index.php?curid=51562781)
