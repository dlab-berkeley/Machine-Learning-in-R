...
> Note: we will also have to manually center and scale these data using the `scale` function. If you select "knn" as the method, values will be automatically centered and scaled. 
